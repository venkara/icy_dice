...
def main() -> int:
    ...
    if background is None:
        print("\nNo empty-tray background is loaded.")
        print("Start with the tray empty and press B after all markers appear.")
    else:
        print(f"\nLoaded background: {BACKGROUND_PATH.resolve()}")
        ...
        while True:
            ...
            if marker_count == 4:
                ...
                if background is not None:
                    ...
                    last_candidates = []
                    last_annotated = placeholder_image("Press B with the tray empty")
            ...
            if key in (ord("c"), ord("C")):
                if background is None:
                    print("Capture blocked: press B with the empty tray first.")
                    continue
                ...
                print(f"Cue: roll {request.expression} again, or press N.")
